...
export const api = {
  ...
  stock: {
    ...
    approveStockLpo: (lpoId) => api.post(`/stock/lpos/${lpoId}/approve`, {}),
    updateStockLpoLineReceipt: (lpoId, lineId, body) => api.patch(`/stock/lpos/${lpoId}/lines/${lineId}/receipt`, body),
